...
<h1 id="pageTitle">Therapists' Messages</h1>
	<div class="row">
		<div class="column2">
<h2 style="margin-top: 0px;">Messages Exchanged</h2>
			<p style="text-align: center;"><u>Here you can see the messages exchanged with therapists.</u></p>
...
<button id="prevTableButton">Prev</button>&nbsp;&nbsp;&nbsp;<button id="nextTableButton">Next</button>
		...
		<div class="column2">
		<h2 style="margin-top: 0px;">Connected Therapists' Accounts</h2>
					<p style="text-align: center;"><u>Here you can see the emails of the therapists with whom you can exchange messages.</u><br>To create a new connection with a therapist, use the relevant field in the "My Account" page.</p>
...
echo "<table>";
	echo "<tr><th><strong>Therapist's Email</strong></th></tr>";
...
echo "<p style='padding: 5px; border: 1px solid #fff;'>There are no verified connections with accounts of trainers.</p>";	
	...
	<hr>
		<div class="row" style="flex-direction: column;">
			...
			<h2 style="margin-top: 0px;">Send new message</h2>
					<p><u>Here you can send new messages to connected therapists' accounts.</u></p>
  ...
  justify-content: space-between;" id="formaNewMessageToTrainer" name="formaNewMessageToTrainer" action="send-message-to-trainer-process.php"  method="POST">
					 <label for="trainersEmail">Email of Therapist</label><br>
					 <input style="padding: 10px;
  width: 100%;
  max-width: 400px; font-size: 15px;" id='trainersEmail' name='trainersEmail' type='email' placeholder='Email'><br>
					 <label for="messageToTrainer">Message to Therapist</label><br>
