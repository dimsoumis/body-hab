...
$user = $_SESSION['userEmail'];  
 ...
 $sql1 = "select * from bbt_scores where user = '$user' ORDER BY reg_date DESC";  
        $result1 = mysqli_query($con, $sql1);  
        $count1 = mysqli_num_rows($result1);


$sqlStats = "select * from bbt_scores where user = '$user'";  
...
<p style="text-align: center;">Check the previous scores you have achieved (higher scores are better).</p>
	...
	for ($x = 1; $x <= $noOfPages; $x++) {
		...
		$sqlLoop = "select * from bbt_scores where user = '$user' ORDER BY reg_date DESC LIMIT 20 OFFSET $x2";  
...
<a href="index.php"><button>Box & Blocks Exercise</button></a>
</p>
	
	<p style="text-align: center;">
<a href="/dashboard/previous-scores/index.php"><button>Previous Scores List</button></a>
</p>
