...
ctx.fillText(cTetr, 220 - tetrD, 225);
		ctx.closePath();
	   
	   // goal 2
	   
ctx.beginPath();	
ctx.rect(490, 390, 300, 300);
ctx.lineWidth = 10;
ctx.strokeStyle = "#000";
ctx.globalAlpha = 1;
ctx.stroke();
...
ctx.beginPath();
ctx.arc(245, 540, 100, 0, 2 * Math.PI);
ctx.lineWidth = 10;
ctx.fillStyle = "#f00";
ctx.globalAlpha = 1;
ctx.fill();
...
ctx.globalAlpha = 1;
ctx.font = "100px Arial";
ctx.fillText(cKikl, 220 - kiklD, 570);
		ctx.closePath();
	   
	   // goal 3
	   
ctx.beginPath();	
ctx.rect(490, 735, 300, 300);
ctx.lineWidth = 10;
ctx.strokeStyle = "#000";
ctx.globalAlpha = 1;
ctx.stroke();
...
ctx.globalAlpha = 1;
ctx.font = "100px Arial";
ctx.fillText(cTria, 220 - triaD, 955);
		ctx.closePath();
...
var countdown = setInterval(function() {
  ...
  if (seconds <= 0) {
	  ...
	  localStorage.setItem("categorizeRightScore", score);
	    exerStarted = 0;
...
/*dim custom code 2 start*/
  ...
  paintShapes(goalShapeX, goalShapeY, chooseShape, counterTetr, tetrDipsifio, counterKikl, kiklDipsifio, counterTria, triaDipsifio);
				...
				if (chooseShape == 0 && goalShapeX > 530 && goalShapeX < 730 && goalShapeY > 115 && goalShapeY < 275) {
			if (hasLetGo == true) {
				counterTetr++;
				score++;
...
chooseShape = randomInt();
		...
		} else if (chooseShape == 1 && goalShapeX > 530 && goalShapeX < 730 && goalShapeY > 460 && goalShapeY < 620) {
			if (hasLetGo == true) {
				counterKikl++;
				score++;
...
chooseShape = randomInt();
		...
		} else if (chooseShape == 2 && goalShapeX > 530 && goalShapeX < 730 && goalShapeY > 805 && goalShapeY < 965) {
			if (hasLetGo == true) {
				counterTria++;
				score++;
