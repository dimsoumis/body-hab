	 ...
	 document.getElementById("currDistRight").innerHTML = Number((dGonat_y - dLekan_y) * 100).toFixed(2);
		...
		function countSitUps() {
			...
			countRepeatsInterval = setInterval(function () {
				...
				if (countTime < 21) {
				  document.getElementById("currentTime").innerHTML = "00:" + (30 - countTime);
				 } else if (countTime < 30) {
				  document.getElementById("currentTime").innerHTML = "00:0" + (30 - countTime);
				 } else {
				  document.getElementById("currentTime").innerHTML = "00:00";
					 clearInterval(countRepeatsInterval);
					 exerActive = false;
					 localStorage.setItem("sitToStand30SecondsScore", countRepeats);
							  		        Swal.fire({
title: 'Maximum time of 30 seconds reached. Your Score is: ' + countRepeats,
showDenyButton: true,
...
<body>
  <div class="container">
   ...
   <!-- <div class="landmark-grid-container"></div> -->
	...
	<div id="currentExerMessage">Exercise: <div id="currentExer">Sit to Stand - 30 seconds</div></div>
