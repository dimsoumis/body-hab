	 ...
	 document.getElementById("currDistRight").innerHTML = Number((dGonat_y - dLekan_y) * 100).toFixed(2);
		...
		function countSitUps() {
			...
			countRepeatsInterval = setInterval(function () {
				...
				if (countTime < 51) {
				  document.getElementById("currentTime").innerHTML = "00:" + (60 - countTime);
				 } else if (countTime < 60) {
				  document.getElementById("currentTime").innerHTML = "00:0" + (60 - countTime);
				 } else {
				  document.getElementById("currentTime").innerHTML = "00:00";
					 clearInterval(countRepeatsInterval);
					 exerActive = false;
					 localStorage.setItem("sitToStand60SecondsScore", countRepeats);
							  		        Swal.fire({
...
<body>
  <div class="container">
   ...
   <!-- <div class="landmark-grid-container"></div> -->
	...
	<div id="currentExerMessage">Exercise: <div id="currentExer">Sit to Stand - 60 seconds</div></div>
