		...
		function countSitUps() {
			...
			countRepeatsInterval = setInterval(function () {
				...
				if (countRepeats == 10) {
					 ...
					 exerActive = false;
					 localStorage.setItem("sitToStand10RepeatsScore", countTime);
							  		        Swal.fire({
title: 'Process of 10 repetitions completed. Your Score is: ' + countTime,
showDenyButton: true,
...
<body>
  <div class="container">
   ...
   <!-- <div class="landmark-grid-container"></div> -->
	...
	<div id="currentExerMessage">Exercise: <div id="currentExer">Sit to Stand - 10 repeats</div></div>
