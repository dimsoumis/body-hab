...
<h2>Account Information</h2>
	...
	<a href="change-information.php"><button>Change Information</button></a><br><br>
			<a href="delete-account.php"><button>Delete Account</button></a><br><br>
	</div>
		<div class="column2">
	<?php if($count > 0) {
		...
		while($row = mysqli_fetch_array($result))
{
			...
			echo "</td></tr><tr><td><strong>Email</strong></td><td>";
				echo $row['email'];
			echo "</td></tr><tr><td><strong>Age</strong></td><td>";
				echo $row['age'];
			echo "</td></tr><tr><td><strong>Gender</strong></td><td>";
				echo $row['gender'];
			echo "</td></tr><tr><td><strong>Status</strong></td><td>";
				echo $row['status'];
	echo "</td></tr>";
